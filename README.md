...
## Nota del deploy automático

Si no configuras los secrets de Vercel, el job de deploy se omite automáticamente y solo corre el job de pruebas.
Esto evita que fallen tus pipelines por configuración incompleta.
